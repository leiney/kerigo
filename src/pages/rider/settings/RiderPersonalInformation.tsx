...
export const RiderPersonalInformation: React.FC = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      // Refetch in background to keep backend sync
  ...
  const displayName = formData.fullName || profileAny?.username || 'Rider Partner';
...
export default RiderPersonalInformation;
