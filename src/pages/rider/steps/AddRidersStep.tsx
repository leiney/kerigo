...
import { User, Plus, Pencil, Trash2, CheckCircle2, X } from 'lucide-react';
...
export const AddRidersStep: React.FC<AddRidersStepProps> = ({ onNext, onBack }) => {
  ...
  return (
    <OnboardingLayout
      currentStep={5}
      stepNumber={3}
      title="Add Riders (Multiple)"
      subtitle="Add details for your riders."
