...
export const RiderTypeSelection: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans antialiased flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 px-6 pt-6 flex flex-col items-center">
        ...
        {/* "I am registering as" Label */}
        <motion.p 
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1 }}
          className="text-sm font-medium text-foreground/70 mb-4 self-start max-w-md"
        >
          I am registering as
        </motion.p>
        ...
        <div className="w-full space-y-4 max-w-md">
          ...
          >
            <div className={`
              ...
              ${accountType === 'individual' ? 'bg-primary text-white' : 'bg-secondary text-foreground/50'}
            `}>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-foreground/50 mt-0.5">
                Register as a company or organisation
              </p>
            </div>
        ...
        <motion.p 
          ...
          className="text-xs text-foreground/50 text-center mt-6 max-w-60"
        >
